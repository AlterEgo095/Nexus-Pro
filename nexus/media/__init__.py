...
class MediaProcessor:
    ...
    async def process_batch(
        self, media_urls: List[str], processing_plan: Dict[str, Any]
    ) -> List[Dict[str, Any]]:
    ...
    async def process_single(
        self, media_url: str, processing_plan: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _process_video(self, url: str, plan: Dict) -> Dict[str, Any]:
        ...
        return {"type": "video", "url": url, "transcript": "video transcript", "scenes": []}
    ...
    async def _process_document(self, url: str, plan: Dict) -> Dict[str, Any]:
        ...
        return {"type": "document", "url": url, "content": "extracted content", "structure": []}
